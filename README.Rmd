...
For versions `2.0.0+` (on Windows 10 and Ubuntu 20.04 as tested), if on loading the package you see error messages like below:
...
Try installing a version of LaTeX (e.g. MikTeX or Tex Live) on your system, and depending on the LaTeX version you may see warnings about various missing packages for `texPreview`, but they can be ignored.
