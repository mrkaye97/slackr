...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/slackr)](http://cran.r-project.org/web/packages/slackr)
...
The `slackr_setup()` function will try to read setup values from a `~/.slackr` (you can change the default) configuration file, which may be 
