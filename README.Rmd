...
- Version `1.2.2` fixed [issue](https://github.com/mrkaye97/slackr/issues/4) (bug in `1.2.1` fix)
- Version `1.2.1` fixed [issue](https://github.com/mrkaye97/slackr/issues/3) when there are no private groups defined 
